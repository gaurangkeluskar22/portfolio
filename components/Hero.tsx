...
const buttons = [
  {
    href: "https://www.linkedin.com/in/gaurang-keluskar/",
  ...
  {
    href: "https://x.com/KeluskarGaurang",
    className: "bg-blue-500 hover:bg-blue-700",
    iconClass: "fab fa-twitter",
    text: "Twitter",
  },
  {
    href: "https://leetcode.com/u/gaurangkeluskar22/",
    className: "bg-yellow-500 hover:bg-yellow-600",
    customIcon: leetcodeIcon,
    text: "LeetCode",
  },
  {
    href: "https://www.geeksforgeeks.org/user/gaurangkeluskar/",
    className: "bg-green-500 hover:bg-green-700",
    customIcon: gfgIcon,
    text: "GeeksforGeeks",
  },
  {
    href: "https://www.hackerrank.com/profile/gaurang_keluskar",
    className: "bg-green-500 hover:bg-green-700",
  ...
  return (
    <section className="max-w-7xl flex flex-col items-center mt-28 pt-16 pb-0 px-4 mx-4 md:mx-4 lg:mx-auto md:px-8 border border-gray-700 rounded-lg bg-primary text-gray-200 shadow-lg">
      <div className="flex flex-col md:flex-row items-center w-full">
        ...
        >
          <motion.img
            src="https://avatars.githubusercontent.com/u/43683829?v=4"
            alt="Gaurang Keluskar"
        ...
        >
          ...
          <motion.p className="text-lg mb-6" variants={itemVariants}>
            👋 Hello! I&apos;m SDE I with 3 years of experience in building
