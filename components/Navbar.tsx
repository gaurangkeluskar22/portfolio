...
const Navbar = () => {
  ...
  return (
    <motion.nav
      ...
      className={`fixed top-0 left-0 right-0 z-50 backdrop-blur-lg bg-primary shadow-lg py-3 transition-all duration-200 ${scrollDirection === "top" ? "bg-opacity-60" : "bg-opacity-40"
        }`}
    >
      <motion.div
      ...
      >
        <div className="flex justify-between items-center">
          ...
          <motion.div
            className={`${isMenuOpen ? "translate-x-0 mr-4 visible" : "translate-x-full invisible"
